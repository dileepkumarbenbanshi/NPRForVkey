...
class SplitViewHouseHoldList: UIView {
    ...
    @IBAction func btnOkTap(_ sender: UIButton) {
        ...
        alertView.showAlert(vc: vc, title: AppMessages().areYouSure, message: "\(modelMember.name ?? "")\(English.HouseholdDetail.shiftMemberIntoHH) \(seletedHHShiftTo.houseHoldhNo ?? "")")
   ...
   @objc func btnRadioTap(sender:UIButton)  {
    ...
    func updateMembrHHDetail()  {
        ...
        modelMember.memberStatus = MemberStatusCode.notAvailable
        ...
        dismissView()
        updateCurrentHhMemberserialNumber()
        }
...
extension SplitViewHouseHoldList:UITableViewDataSource,UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell?.lblName.text = hhModel.headName
