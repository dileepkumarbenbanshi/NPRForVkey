...
/// ## Usage
/// Add the NPRSignatureDelegate to the view to exploit the optional delegate methods
/// - startedDrawing(_ view: NPRDrawSignatureView)
/// - finishedDrawing(_ view: NPRDrawSignatureView)
...
/// - getCroppedSignature()
@IBDesignable
final public class NPRDrawSignatureView: UIView {
    
    public weak var delegate: NPRSignatureDelegate?
...
// MARK: - Protocol definition for NPRDrawSignatureViewDelegate
/// ## NPRDrawSignatureViewDelegate Protocol
/// NPRDrawSignatureViewDelegate:
/// - optional didStart(_ view : NPRDrawSignatureView)
/// - optional didFinish(_ view : NPRDrawSignatureView)
@objc
public protocol NPRSignatureDelegate: class {
    func didStart(_ view : NPRDrawSignatureView)
    func didFinish(_ view : NPRDrawSignatureView)
}

extension NPRSignatureDelegate {
    func didStart(_ view : NPRDrawSignatureView) {}
    func didFinish(_ view : NPRDrawSignatureView) {}
}
