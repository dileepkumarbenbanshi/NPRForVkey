...
extension DBManagerMemberDetail {
    ...
    func save2021HHDetail(hhModel:NPRData2021ModelClassResult,Completion:@escaping(Bool) -> Void ){
        ...
        if hhModel.relCode == "01" || hhModel.slnoMember.memberSrNumber() == "01".memberSrNumber() {
    ...
    func save2021MemberDetail (hhModel:NPRData2021ModelClassResult,Completion:@escaping(Bool) -> Void ) {
        ...
        nprData?.language = hhModel.language ?? "en"
        ...
        let censuHN = hhModel.censusHouseNo ?? ""
        
        nprData?.censusHouse_number = censuHN.censusHHNumber()
        
        let censusHH = hhModel.censusHhNo ?? ""
        
        nprData?.censusHH_number = censusHH.censusHHNumber()
        
        let hhNumber = hhModel.slnohhd ?? ""
        
        nprData?.hh_Number = hhNumber.hhNumber()
        ...
        nprData?.last_name_sl = hhModel.lastName_sl ?? ""
        ...
        nprData?.otherMotherTounge = hhModel.otherMotherTongue ?? ""
        ...
        nprData?.father_name_sl = hhModel.fatherNamesl ?? ""
        ...
        nprData?.motherName_sl = hhModel.motherNamesl ?? ""
       ...
       //  nprData?.driving_lincence = hhModel.dl
        ...
        let memberStatus = MemberLivingStatusCode.init(rawValue: "\(hhModel.memberStatus ?? 0)")
         ...
         default:
            ...
            nprData?.relNameSL = hhModel.oefRelNamesl ?? ""
            ...
            nprData?.birth_country_sl = hhModel.oefBirthCountryNamesl ?? ""
            ...
            nprData?.birth_state_sl = hhModel.oefBirthStateNamesl ?? ""
            ...
            nprData?.birth_district_sl = hhModel.oefBirthDistrictNamesl ?? ""
            ...
            nprData?.eduName_sl = hhModel.oefEduNamesl ?? ""
           ...
           // nprData?.occuName_sl = hhModel.oefOccuNamesl  ?? ""
            ...
            nprData?.address_stateName_sl = hhModel.oefPresentStatesl ?? ""
            ...
            nprData?.address_district_sl = hhModel.oefPresentDistrictsl ?? ""
            ...
            nprData?.address_subDistrict_sl = hhModel.oefPresentTehsilsl ?? ""
